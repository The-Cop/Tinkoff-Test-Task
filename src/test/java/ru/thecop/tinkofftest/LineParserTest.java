...
public class LineParserTest {
    ...
    public void testNormal(){
        Entry e = LineParser.parseLine("2015-10-26T16:10:01,733 TRACE [OperationsImpl] entry with (processAction:17904)");
        assertNotNull(e);
    ...
    public void testWrongType(){
        Entry e = LineParser.parseLine("2015-10-26T16:10:01,733 TRACE [OperationsImpl] zzentry with (processAction:17904)");
        assertNull(e);
    }

    @Test
    public void testWrongCallId(){
        Entry e = LineParser.parseLine("2015-10-26T16:10:01,733 TRACE [OperationsImpl] entry with (processAction:17a904)");
        assertNull(e);
    }

    @Test
    public void testWrongDate(){
        Entry e = LineParser.parseLine("2015-10-26Z16:10:01,733 TRACE [OperationsImpl] entry with (processAction:17904)");
        assertNull(e);
    }
}
